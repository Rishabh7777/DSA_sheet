...
public class IntervalTree {
    ...
    public static Interval isOverlapping(Node root, Interval x) {
        ...
        if((x.low > root.range.low && x.low < root.range.high) || (x.high > root.range.low && x.high < root.range.high)) {
            return root.range;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Overlaps with " + isOverlapping(root, new Interval(6, 7)));
    }
}
